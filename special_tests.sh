...
COMMON_ARGS="-m -i 50 -s 500 -r 50000000"
...
for s in ${pagesizes[*]}
do
./mara.sh ${COMMON_ARGS} -n 4 -x 1000 -p ${s}
./mara.sh ${COMMON_ARGS} -n 4 -x 32 -p ${s}
./mara.sh ${COMMON_ARGS} -n 1000 -x 4000 -p ${s}
./mara.sh ${COMMON_ARGS} -n 4 -x 4000 -p ${s}
./mara.sh ${COMMON_ARGS} -n 100 -x 500 -p ${s}
done
