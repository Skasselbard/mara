...
byte *
CodeBlock::getCodeBlockForInternalSize(byte *leftStartOfBlock, size_t internallyNeededSize, size_t &returnArraySize,
                                       bool isFree) {
#ifdef PRECONDITION
    ...
    byte *returnByte = CodeBlock::getCodeBlockForPayloadSize(leftStartOfBlock,
                                                             internallyNeededSize - 2 * returnArraySize, isFree,
                                                             returnArraySize);
#ifdef POSTCONDITION
